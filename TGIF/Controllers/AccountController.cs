...
namespace TGIF.Controllers
{
    ...
    {
        TGIFDBContext db = new TGIFDBContext();
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                using (TGIFDBContext db = new TGIFDBContext())
                {
        ...
        public ActionResult UserList(string searchTerm = null)
        {
            
            var model = from r in db.UserProfiles
                        where (searchTerm == null || r.SchoolName.StartsWith(searchTerm))
                        orderby r.SchoolName ascending
                        select r;
        ...
        public ActionResult ExportUserList()
        {
            ...
            gv.DataSource = db.UserProfiles.ToList();
            gv.DataBind();
            Response.ClearContent();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", "attachment; filename=TGIFUserlist.xls");
        ...
        public ActionResult EditUser(UserProfile userProfile)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                return RedirectToAction("UserDetail", new { id = WebSecurity.GetUserId(User.Identity.Name) });
            }
            return View(userProfile);
        }
